...
$(function () {
  $(".en").click(function () {
    ...
    $(".banne3__texto-card4").text("Now is the time to further refine Conversation with discussion topics using connectives, and improve your performance in fluency using advanced discussion and discussion techniques in English.");
    ...
    $(".card1_texto_dois").text("Take classes anywhere");
    ...
    $(".card2_texto_dois").text("Take classes anywhere");
    $(".card3__plan").text("Personal Teacher");
    ...
    $(".card3_texto_dois").text("Take classes anywhere");
    $(".card3__plan").text("Personal Teacher");
    ...
    $(".card4_texto_dois").text("Take classes anywhere");
    $(".card3__plan").text("Personal Teacher");
